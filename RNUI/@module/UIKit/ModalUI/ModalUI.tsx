...
const ModalUI = ({ renderContent,
    ...
    const animatedValue = useRef(new Animated.Value(animationType == 'TranslateBottomToTop' ? 500 : 0)).current
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <TouchableOpacity activeOpacity={1} style={[styles.modalBackground, getTypeValue?.containerStyle]} onPress={onClose}>
                    <TouchableWithoutFeedback>
                        <Animated.View ref={myRef} onLayout={onLayout} style={[styles.modalContainer, {
                            height: modalHeight, width: modalWidth, ...getTypeValue?.animationStyle
                        }]}>
